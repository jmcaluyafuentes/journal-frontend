...
const App = () => {
    ...
    useEffect(() => {
        fetch("https://journal-api-ri55.onrender.com/categories")
            .then((res) => res.json())
            .then((data) => setCategories(data))

        fetch("https://journal-api-ri55.onrender.com/entries")
            .then((res) => res.json())
    ...
    const addEntry = async (cat_id, content) => {
        ...
        const res = await fetch('https://journal-api-ri55.onrender.com/entries', {
            method: 'POST',
            headers: {
